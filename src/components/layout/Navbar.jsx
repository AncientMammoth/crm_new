...
export default function Navbar({ setSidebarOpen }) {
  // CHANGED: Using useState and useEffect to correctly handle the login state.
  ...
  return (
    ...
    >
      ...
      {/* Only show mobile menu button if logged in */}
      {isLoggedIn && (
        <button
          type="button"
      ...
      <div className="flex flex-1 items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center space-x-8">
          ...
          {/* Conditionally render the main navigation for logged-in users */}
          {isLoggedIn && (
        ...
        {/* Conditionally render the right-side icons for logged-in users */}
        {isLoggedIn && (
